...
def get_args_parser(subparsers):
    ...
    # Flags for different modes of execution
    subparsers.add_argument('--use_transform', default=False , action='store_true', help='Use SLCA transforms')
    subparsers.add_argument('--use_clip_grad', default=False , action='store_true', help='Using gradient clipping')
    subparsers.add_argument('--SLCA', default=True , action='store_false', help='Perform training on top of SLCA')

    subparsers.add_argument('--logit_norm', default=0.1 , action='store_true', help='Value of logit normaliser')
    subparsers.add_argument('--ca_epochs', type=int, default=5, help='Number of Classifier align epochs')
    ...
    subparsers.add_argument('--weight-decay', type=float, default=5e-4, help='weight decay (default: 0.0)')
    ...
    subparsers.add_argument('--lr_orig', type=float, default=0.01, metavar='LR', help='learning rate (default: 0.03)')
    subparsers.add_argument('--lr_cls', type=float, default=0.01, metavar='LR', help='learning rate (default: 0.03)')
    subparsers.add_argument('--lr_rps', type=float, default=0.0001, metavar='LR', help='learning rate (default: 0.03)')
    ...
    subparsers.add_argument('--output_dir', default='/raid/anurag_raid/', help='path where to save, empty for no saving')
    subparsers.add_argument('--device', default='cuda', help='device to use for training / testing')
    subparsers.add_argument('--seed', default=1993, type=int)
    ...
    subparsers.add_argument('--num_prompts_per_task', default=1, type=int, help='max number of prompts to be generated for each task')
    subparsers.add_argument('--initial_num_prompts', default=5, type=int, help='number of learnable prompts for the initial task')
