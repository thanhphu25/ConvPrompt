...
def get_args_parser(subparsers):
    ...
    subparsers.add_argument('--opt', default='SGD', type=str, metavar='OPTIMIZER', help='Optimizer (default: "adam"')
    ...
    subparsers.add_argument('--output_dir', default='./outputs', help='path where to save, empty for no saving')
