...
def get_args_parser(subparsers):
    ...
    subparsers.add_argument('--SLCA', default=False , action='store_false', help='Perform training on top of SLCA')
    ...
    subparsers.add_argument('--sched', default='cosine', choices=['cosine', 'multistep'], type=str, metavar='SCHEDULER', help='LR scheduler (default: "constant"')
